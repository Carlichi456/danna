...
$consulta='SELECT * FROM doctor_pao';
$resultado= mysqli_query($conexion,$consulta);


echo'<center>
<h3>Registros Almacenados en la Base de Datos
<p>
<table border="2"style=color:white;font-family:Consolas>
<tr bgcolor=black>
  <th width=100 height=40>Id</th>
  <th width=100 height=40>Nombres</th>
  <th>Apellidos</th>
  <th>Edad</th>
  <th>Genero</th>
 <th>Especialidad</th>
 <th>Instrumentos_medicos</th>
    ...
    while ($columna = mysqli_fetch_array( $resultado ))
    {
        ...
        echo "
            <td>" . $columna['Id'] . "</td>
            <td>" . $columna['Nombres'] . "</td>
            <td>" . $columna['Apellidos'] . "</td>
            <td>" . $columna['Edad'] . "</td>
            <td>" . $columna['Genero'] . "</td>
            <td>" . $columna['Especialidad'] . "</td>
            <td>" . $columna['Instrumentos_medicos'] . "</td>";
        echo "</tr>";
    }
    echo "</table>"; 
